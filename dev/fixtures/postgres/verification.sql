-- Verification schema of the PostgreSQL development database, loaded after "Le Fil" (schema.sql).
-- Each object is here for a case the PostgreSQL dialect must get right, rather than to look like real data.
